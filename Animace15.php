...
<head>
    ...
    <style>
        ...
        .image-container {
            ...
            overflow: hidden; /* skryje přetečení při zoomu */
        }
        ...
        .image-container img {
            ...
            height: auto;
            display: block;
            transition: transform 0.3s ease-in-out; /* plynulý přechod zoomu */
        }

        .image-container:hover img {
            transform: scale(1.2); /* přiblížení o 20% */
        }
